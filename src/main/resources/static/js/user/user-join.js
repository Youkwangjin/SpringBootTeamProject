window.onload = function () {
    ...
    pw1.addEventListener("focusout", checkJoinPw);
    pw2.addEventListener("focusout", checkJoin2Pw);
    name.addEventListener("focusout", checkJoinName);
    email.addEventListener("focusout", checkJoinEmail);
    tel.addEventListener("focusout", checkJoinTel);
    jumin.addEventListener("focusout", checkJoinJumin);
