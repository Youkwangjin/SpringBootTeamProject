...
public enum ApiErrorCode {
    ...
    CONTAINER_APPROVAL_NOT_PENDING(HttpStatus.INTERNAL_SERVER_ERROR, "CAP", "승인 대기 상태에서만 수정이 가능합니다."),
    CONTAINER_STATUS_NOT_PENDING(HttpStatus.INTERNAL_SERVER_ERROR,   "CSP", "사용 대기 상태에서만 수정이 가능합니다."),
