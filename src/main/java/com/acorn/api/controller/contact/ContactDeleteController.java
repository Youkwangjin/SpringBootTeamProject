...
import com.acorn.api.dto.contact.ContactDeleteDTO;
...
public class ContactDeleteController {
    ...
    public ResponseEntity<ApiSuccessResponse<Object>> contactDelete(@Valid @RequestBody ContactDeleteDTO deleteData) {
